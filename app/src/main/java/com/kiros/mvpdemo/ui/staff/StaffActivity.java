...
import com.kiros.mvpdemo.fragment.StaffFragment;
...
public class StaffActivity extends AppCompatActivity {
    ...
    private Class mClass[] = {StaffFragment.class, NoticeFragment.class, MineFragment.class};
    private Fragment mFragment[] = {new StaffFragment(), new NoticeFragment(), new MineFragment()};
