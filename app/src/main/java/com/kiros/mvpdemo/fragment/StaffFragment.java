...
import com.kiros.mvpdemo.ui.staff.AbnormalEqActivity;
import com.kiros.mvpdemo.ui.staff.MaintenanceActivity;
import com.kiros.mvpdemo.ui.staff.MaintenedActivity;
import com.kiros.mvpdemo.ui.staff.OverdueMaintenanceActivity;
import com.kiros.mvpdemo.ui.staff.WillMaintenanceActivity;
import com.kiros.mvpdemo.ui.staff.WorkSummaryActivity;
...
//    String[] urls = getResources().getStringArray(R.array.url);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return LayoutInflater.from(getActivity()).inflate(R.layout.fragment_staff_home, container, false);
    }
...
//                .start();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.guarantee:
                intent = new Intent(getContext(), MaintenedActivity.class);
                break;
            case R.id.maintenance:
                intent = new Intent(getContext(), WillMaintenanceActivity.class);
                break;
            case R.id.feedback:
                intent = new Intent(getContext(), OverdueMaintenanceActivity.class);
                break;
            case R.id.curing:
                intent = new Intent(getContext(), AbnormalEqActivity.class);
                break;
            case R.id.eq_run:
                intent = new Intent(getContext(), MaintenanceActivity.class);
                break;
            case R.id.infringement:
                intent = new Intent(getContext(), WorkSummaryActivity.class);
                break;
            case R.id.sign:
                sign();
                break;
